...
//            String ncc ="Con cac du me thang lz Sinh";
...
//            paragraph2.add(new Chunk(createWhiteSpace(5)));
//            String diachincc ="Con cac du me thang lz Sinh";
...
//    }
    ...
    public void writePX(int maphieu) {
        ...
        try {
           ...
           // P//aragraph paragraph2 = new Paragraph("khách hàng: " + hoten, fontNormal10);
           // paragraph2.add(new Chunk(createWhiteSpace(5)));
          //  paragraph2.add(new Chunk("-"));
          //  paragraph2.add(new Chunk(createWhiteSpace(5)));
          ...
          //  P//aragraph paragraph4 = new Paragraph("Thời gian nhập: " + formatDate.format(px.getThoigiantao()), fontNormal10);
          //  document.add(paragraph1);
          //  document.add(paragraph2);
            document.add(paragraph3);
           // document.add(paragraph4);
