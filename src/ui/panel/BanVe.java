...
public final class BanVe extends JPanel implements ActionListener, MouseListener, PropertyChangeListener, ItemListener {
    ...
    public BanVe(Main m) {
        ...
        this.tableChuyenTau.addMouseListener(this);
    }
